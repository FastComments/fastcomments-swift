...
public struct GetUsersInfoResponse: Sendable, Codable, Hashable {
    ...
    public init(users: [PageUserEntry]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.users = users
        self.status = status
        self.reason = reason
        self.code = code
