...
public struct GetPagesPublicResponse: Sendable, Codable, Hashable {
    ...
    public init(nextCursor: String? = nil, pages: [PublicPage]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
