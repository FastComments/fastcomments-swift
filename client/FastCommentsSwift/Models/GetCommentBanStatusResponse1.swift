//
// GetCommentBanStatusResponse1.swift
//
...
public struct GetCommentBanStatusResponse1: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, emailDomain: String? = nil, canIPBan: Bool? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(canIPBan, forKey: .canIPBan)
