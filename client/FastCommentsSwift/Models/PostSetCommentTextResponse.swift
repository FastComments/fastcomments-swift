//
// PostSetCommentTextResponse.swift
//
...
public struct PostSetCommentTextResponse: Sendable, Codable, Hashable {
    ...
    public init(newCommentTextHTML: String? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(newCommentTextHTML, forKey: .newCommentTextHTML)
