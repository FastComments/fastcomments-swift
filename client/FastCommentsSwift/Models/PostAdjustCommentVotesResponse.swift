//
// PostAdjustCommentVotesResponse.swift
//
...
public struct PostAdjustCommentVotesResponse: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, newCommentVotes: Int? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(newCommentVotes, forKey: .newCommentVotes)
