...
public struct GetTenantPackages200Response: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(status: APIStatus, tenantPackages: [TenantPackage], reason: String, code: String, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
