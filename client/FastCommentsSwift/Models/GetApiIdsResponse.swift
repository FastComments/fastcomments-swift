...
public struct GetApiIdsResponse: Sendable, Codable, Hashable {
    ...
    public init(ids: [String]? = nil, hasMore: Bool? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.ids = ids
