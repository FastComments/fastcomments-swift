//
// GetCachedNotificationCount200Response.swift
//
...
public struct GetCachedNotificationCount200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, data: UserNotificationCount? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
        self.data = data
        self.reason = reason
        self.code = code
