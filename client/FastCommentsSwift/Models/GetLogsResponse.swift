...
public struct GetLogsResponse: Sendable, Codable, Hashable {
    ...
    public init(logs: [ModerationAPICommentLog]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.logs = logs
        self.status = status
        self.reason = reason
        self.code = code
