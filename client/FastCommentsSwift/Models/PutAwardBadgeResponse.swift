...
public struct PutAwardBadgeResponse: Sendable, Codable, Hashable {
    ...
    public init(notes: [String]? = nil, badges: [CommentUserBadgeInfo]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.notes = notes
        self.badges = badges
        self.status = status
        self.reason = reason
