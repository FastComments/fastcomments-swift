...
public struct GetSearchPagesResponse: Sendable, Codable, Hashable {
    ...
    public init(pages: [ModerationPageSearchProjected]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.pages = pages
        self.status = status
        self.reason = reason
        self.code = code
