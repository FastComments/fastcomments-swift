//
// PostBanUserFromCommentResponse.swift
//
...
public struct PostBanUserFromCommentResponse: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, changelog: APIBanUserChangeLog? = nil, code: String? = nil, reason: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
