//
// ResetUserNotifications200Response.swift
//
...
public struct ResetUserNotifications200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, code: String? = nil, reason: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
        self.code = code
        self.reason = reason
