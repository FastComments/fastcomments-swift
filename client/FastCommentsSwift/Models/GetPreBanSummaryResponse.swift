//
// GetPreBanSummaryResponse.swift
//
...
public struct GetPreBanSummaryResponse: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, usernames: [String]? = nil, count: Double? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
