//
// BulkCreateHashTagsResponseResultsInner.swift
//
...
public struct BulkCreateHashTagsResponseResultsInner: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, hashTag: TenantHashTag? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
