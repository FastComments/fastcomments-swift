...
public struct GetGifLargeResponse: Sendable, Codable, Hashable {
    ...
    public init(src: String? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.src = src
        self.status = status
        self.reason = reason
        self.code = code
