...
public struct GetManualBadgesResponse: Sendable, Codable, Hashable {
    ...
    public init(badges: [TenantBadge]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.badges = badges
        self.status = status
        self.reason = reason
        self.code = code
