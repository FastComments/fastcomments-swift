//
// GetEmailTemplateDefinitions200Response.swift
//
...
public struct GetEmailTemplateDefinitions200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, definitions: [EmailTemplateDefinition]? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
