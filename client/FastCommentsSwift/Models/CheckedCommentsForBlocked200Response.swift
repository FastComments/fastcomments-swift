//
// CheckedCommentsForBlocked200Response.swift
//
...
public struct CheckedCommentsForBlocked200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(commentStatuses: [String: Bool]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(commentStatuses, forKey: .commentStatuses)
