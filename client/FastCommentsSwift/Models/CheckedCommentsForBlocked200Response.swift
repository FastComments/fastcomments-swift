...
public struct CheckedCommentsForBlocked200Response: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(commentStatuses: [String: Bool], status: APIStatus, reason: String, code: String, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
