//
// GetModerators200Response.swift
//
...
public struct GetModerators200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, moderators: [Moderator]? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(moderators, forKey: .moderators)
