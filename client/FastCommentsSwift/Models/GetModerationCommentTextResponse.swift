//
// GetModerationCommentTextResponse.swift
//
...
public struct GetModerationCommentTextResponse: Sendable, Codable, Hashable {
    ...
    public init(comment: String? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
