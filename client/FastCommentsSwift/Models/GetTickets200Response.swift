...
public struct GetTickets200Response: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(status: APIStatus, tickets: [APITicket], reason: String, code: String, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
