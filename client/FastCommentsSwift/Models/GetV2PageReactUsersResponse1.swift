//
// GetV2PageReactUsersResponse1.swift
//
...
public struct GetV2PageReactUsersResponse1: Sendable, Codable, Hashable {
    ...
    public init(userNames: [String]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
