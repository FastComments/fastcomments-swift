...
public struct SetTrustFactorResponse: Sendable, Codable, Hashable {

    public var previousManualTrustFactor: Double?
    ...
    public init(previousManualTrustFactor: Double? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.previousManualTrustFactor = previousManualTrustFactor
        self.status = status
        self.reason = reason
        self.code = code
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        case previousManualTrustFactor
        case status
        case reason
        case code
        case secondaryCode
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(previousManualTrustFactor, forKey: .previousManualTrustFactor)
