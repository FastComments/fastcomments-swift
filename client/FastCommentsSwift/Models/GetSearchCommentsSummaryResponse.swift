//
// GetSearchCommentsSummaryResponse.swift
//
...
public struct GetSearchCommentsSummaryResponse: Sendable, Codable, Hashable {
    ...
    public init(commentCount: Int? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
