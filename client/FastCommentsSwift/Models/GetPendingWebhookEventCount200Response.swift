...
public struct GetPendingWebhookEventCount200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, count: Double? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
        self.count = count
        self.reason = reason
        self.code = code
