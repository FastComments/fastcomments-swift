...
public struct GetSearchSitesResponse: Sendable, Codable, Hashable {
    ...
    public init(sites: [ModerationSiteSearchProjected]? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.sites = sites
        self.status = status
        self.reason = reason
        self.code = code
