...
public struct GetUserPresenceStatuses200Response: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(status: APIStatus, userIdsOnline: [String: Bool], reason: String, code: String, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
