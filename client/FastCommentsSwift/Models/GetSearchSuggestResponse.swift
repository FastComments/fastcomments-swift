//
// GetSearchSuggestResponse.swift
//
...
public struct GetSearchSuggestResponse: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, pages: [ModerationPageSearchProjected]? = nil, users: [ModerationUserSearchProjected]? = nil, code: String? = nil, reason: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
        self.pages = pages
        self.users = users
        self.code = code
