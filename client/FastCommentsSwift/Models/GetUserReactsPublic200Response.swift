//
// GetUserReactsPublic200Response.swift
//
...
public struct GetUserReactsPublic200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, reacts: [String: [String: Bool]]? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
        self.reacts = reacts
        self.reason = reason
        self.code = code
