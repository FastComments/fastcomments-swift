//
// GetUserInternalProfileResponse1.swift
//
...
public struct GetUserInternalProfileResponse1: Sendable, Codable, Hashable {
    ...
    public init(profile: GetUserInternalProfileResponseProfile? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
