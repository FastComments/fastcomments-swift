//
// SetCommentText200Response.swift
//
...
public struct SetCommentText200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(comment: SetCommentTextResult? = nil, status: APIStatus, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
