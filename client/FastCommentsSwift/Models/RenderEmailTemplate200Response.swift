//
// RenderEmailTemplate200Response.swift
//
...
public struct RenderEmailTemplate200Response: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(status: APIStatus, html: String? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
        self.html = html
        self.reason = reason
        self.code = code
