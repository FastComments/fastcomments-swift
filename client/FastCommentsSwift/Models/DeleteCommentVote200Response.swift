//
// DeleteCommentVote200Response.swift
//
...
public struct DeleteCommentVote200Response: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(status: APIStatus? = nil, wasPendingVote: Bool? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
