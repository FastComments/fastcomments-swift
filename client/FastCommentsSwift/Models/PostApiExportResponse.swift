...
public struct PostApiExportResponse: Sendable, Codable, Hashable {
    ...
    public init(status: APIStatus, batchJobId: String? = nil, reason: String? = nil, code: String? = nil, secondaryCode: String? = nil, bannedUntil: Int64? = nil, maxCharacterLength: Int? = nil, translatedError: String? = nil, customConfig: CustomConfigParameters? = nil) {
        self.status = status
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(batchJobId, forKey: .batchJobId)
