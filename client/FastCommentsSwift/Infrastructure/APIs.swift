...
open class FastCommentsSwiftAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://fastcomments.com",
    ...
    public static let shared = FastCommentsSwiftAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: FastCommentsSwiftAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: FastCommentsSwiftAPIConfiguration = FastCommentsSwiftAPIConfiguration.shared) {
        self.method = method
